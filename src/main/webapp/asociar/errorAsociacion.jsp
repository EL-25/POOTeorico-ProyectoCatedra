...
<%
    ...
    } else if ("falloAsociacion".equals(tipoError)) {
        mensaje = "¡No se pudo asociar el cliente. Intente nuevamente.!";
    } else if ("duplicado".equals(tipoError)) {
        mensaje = "¡El cliente ya está asociado a esa institución!";
    }
...
<head>
    <meta charset="UTF-8">
    <title>Error en Asociación</title>
    <style>
        body {
...
<div class="mensaje-error">
    ...
    <a href="asociarCliente.jsp" class="boton">Volver al formulario</a>
